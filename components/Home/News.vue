        ...
        <div class="flex justify-between mt-[2.6vw] w-full">
            <div v-for="(item, index) in newList" :key="index" class="w-[15.05vw]">
                ...
                <div class="flex flex-col p-[1.04vw] font-normal">
                    ...
                    <div class="text-[#555555] mt-[1.04vw] leading-[1.88vw] text-[1.15vw]">{{ item.content }}</div>
...
const newList = ref([
    {title: '姬器人创始人  CTO...', content: '2024年6月29日，由哈佛大学无锡校友会举办的 AIEC人工智能与俱身...', time: '2024-06-29', img: logo},
    {title: '姬器人创始人  CTO...', content: '2024年10月11日，1苏州市太仓市委常委、组织部部长、苏州市人社局...', time: '2024-06-29', img: logo},
    {title: '姬器人创始人  CTO...', content: '2024年10月26日，创始人卢树强受邀参加出席由声网科技主办的 声网...', time: '2024-06-29', img: logo},
    {title: '姬器人创始人  CTO...', content: '2024年6月29日，由哈佛大学无锡校友会举办的 AIEC人工智能与俱身...', time: '2024-06-29', img: logo}
])
</script>

...
import unit4 from '@/assets/img/unit4.png'
import unit5 from '@/assets/img/unit5.png'
...
const unitList = ref([
    { name: 'MIT', logo: unit1 },
    { name: '北京协和医院', logo: unit2 },
    { name: '安贞医院', logo: unit3 },
])

const unitList2 = ref([
    { name: '阜外医院', logo: unit4 },
    { name: '斯坦福大学', logo: unit5 },
    { name: '上海交通大学', logo: unit6 },
])
</script>
